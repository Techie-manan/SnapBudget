...
const Contact = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-home px-5 py-10 text-white">
      ...
      {/* Contact Form */}
      <form className="card rounded-3xl shadow-lg p-10 w-full max-w-lg flex flex-col gap-6">

        <input
          type="text"
          placeholder="Your Name"
          className="px-6 mx-5 mt-5 py-4 text-center bg-gray-600 text-white rounded-full focus:outline-none focus:ring-2 focus:ring-amber-400 placeholder:text-gray-400"
        />

        <input
          type="email"
          placeholder="Your Email"
          className="px-6 mx-5 py-4 bg-gray-600 text-center text-white rounded-full focus:outline-none focus:ring-2 focus:ring-amber-400 placeholder:text-gray-400"
        />

        <textarea
          placeholder="Your Message"
          className="px-6 py-4 mx-5 h-40 bg-gray-600 text-center text-white rounded-3xl focus:outline-none focus:ring-2 focus:ring-amber-400 placeholder:text-gray-400 resize-none"
        />
